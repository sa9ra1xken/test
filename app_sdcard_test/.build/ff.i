# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 289 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c" 2
# 95 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
...
# 95 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c" 2

# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/diskio.h" 1
# 16 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/diskio.h"
...
# 96 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c" 2
# 467 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FATFS *FatFs[1];
...
static
BYTE CurrVol;
# 492 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static WCHAR LfnBuf[255 +1];
# 518 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
...
# 555 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
void mem_cpy (void* dst, const void* src, UINT cnt) {
  BYTE *d = (BYTE*)dst;
  const BYTE *s = (const BYTE*)src;
# 567 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
  while (cnt--)
    *d++ = *s++;
}
...
# 745 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT move_window (
  FATFS *fs,
  DWORD sector
...
# 787 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT sync (
  FATFS *fs
)
...
# 828 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
DWORD clust2sect (
  FATFS *fs,
  DWORD clst
)
...
# 846 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
DWORD get_fat (
  FATFS *fs,
  DWORD clst
)
...
# 889 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT put_fat (
  FATFS *fs,
  DWORD clst,
  DWORD val
...
# 951 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
...
# 989 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
      clst = nxt;
    }
  }
...
# 1004 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
DWORD create_chain (
  FATFS *fs,
  DWORD clst
...
# 1091 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT dir_sdi (
  DIR *dj,
  WORD idx
...
# 1139 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT dir_next (
  DIR *dj,
  int stretch
...
# 1207 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
...
# 1312 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
void gen_numname (
  BYTE *dst,
  const BYTE *src,
  const WCHAR *lfn,
...
# 1359 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
BYTE sum_sfn (
  const BYTE *dir
)
...
# 1379 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT dir_find (
  DIR *dj
)
...
# 1440 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT dir_read (
  DIR *dj
)
...
# 1497 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
...
# 1580 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
  if (res == FR_OK) {
    res = move_window(dj->fs, dj->sect);
    if (res == FR_OK) {
      dir = dj->dir;
...
# 1604 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT dir_remove (
  DIR *dj
)
...
# 1638 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
  return res;
}
# 1649 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT create_name (
  DIR *dj,
  const TCHAR **path
)
{
  ...
  *path = &p[si];
  ...
  return FR_OK;
# 1854 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
}
# 1863 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
void get_fileinfo (
  DIR *dj,
  FILINFO *fno
...
# 1945 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT follow_path (
  DIR *dj,
  const TCHAR *path
...
# 2008 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
BYTE check_fs (
  FATFS *fs,
  DWORD sect
...
# 2034 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT chk_mounted (
  const TCHAR **path,
  FATFS **rfs,
...
# 2199 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
static
FRESULT validate (
  FATFS *fs,
  WORD id
...
# 2231 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_mount (
  BYTE vol,
  FATFS *fs
)
...
# 2271 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_open (
  FIL *fp,
  const TCHAR *path,
  BYTE mode
...
# 2377 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
            ;
...
# 2401 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_read (
  FIL *fp,
  void *buff,
  UINT btr,
...
# 2478 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
      fp->dsect = sect;
    }
...
# 2502 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_write (
  FIL *fp,
  const void *buff,
  UINT btw,
...
# 2621 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_sync (
  FIL *fp
)
{
  ...
  if (res == FR_OK) {
    if (fp->flag & 0x20) {
# 2641 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
...
# 2668 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_close (
  FIL *fp
)
{
  FRESULT res;
# 2681 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
  res = f_sync(fp);
# 2695 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
  if (res == FR_OK) fp->fs = 0;
  return res;

}
# 2709 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_chdrive (
  BYTE drv
)
{
...
# 2832 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_lseek (
  FIL *fp,
  DWORD ofs
)
{
  ...
  if (fp->flag & 0x80)
    return FR_INT_ERR;
# 2903 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
  {
...
# 2970 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
      fp->dsect = nsect;
    }
...
# 2990 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_opendir (
  DIR *dj,
  const TCHAR *path
)
...
# 3030 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_readdir (
  DIR *dj,
  FILINFO *fno
)
...
# 3072 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_stat (
  const TCHAR *path,
  FILINFO *fno
)
...
# 3105 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_getfree (
  const TCHAR *path,
  DWORD *nclst,
  FATFS **fatfs
...
# 3216 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_unlink (
  const TCHAR *path
)
{
...
# 3284 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_mkdir (
  const TCHAR *path
)
{
...
# 3357 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_chmod (
  const TCHAR *path,
  BYTE value,
  BYTE mask
...
# 3399 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_utime (
  const TCHAR *path,
  const FILINFO *fno
)
...
# 3440 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
FRESULT f_rename (
...
# 3890 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
TCHAR* f_gets (
  TCHAR* buff,
  int len,
  FIL* fil
)
{
  ...
  while (n < len - 1) {
    ...
    if (rc != 1) break;
    c = s[0];
# 3927 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
    if (c == '\r') continue;
...
# 3940 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c" 2
...
)
{
  ...
  if (c == '\n') f_putc ('\r', fil);
# 3974 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src/ff.c"
  s[0] = (BYTE)c;
  btw = 1;
