# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc" 2
# 1 ".././src\\customdefines.h" 1
# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc" 2

# 1 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src\\diskio.h" 1
# 12 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src\\diskio.h"
...
# 12 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_FatFs/src\\diskio.h" 2
...
# 2 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc" 2
...
# 4 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc" 2
...
int clz(unsigned x);
# 5 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc" 2
...
# 1 "C:\\\\MEGA\\\\HobbyElec\\\\SSDAC\\\\xSSDAC\\\\xTIME\\\\WORKSPACE040\\\\app_sdcard_test\\\\.build\\\\xSSDAC-SD-V1.h" 1 3
# 13 "C:\\\\MEGA\\\\HobbyElec\\\\SSDAC\\\\xSSDAC\\\\xTIME\\\\WORKSPACE040\\\\app_sdcard_test\\\\.build\\\\xSSDAC-SD-V1.h" 3
...
# 6 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc" 2
...
typedef struct SDHostInterface
{
  ...
  port Cmd;
  port Dat;
# 28 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc"
  unsigned long Rca;
  unsigned char Ccs;
  unsigned long BlockNr;
} SDHostInterface;
# 40 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc"
...
# 71 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc"
int Is_XS1_G_Core = 0;
...
static DRESULT SendCmd(BYTE IfNum, BYTE Cmd, DWORD Arg, RESP_TYPE RespType, int DataBlocks, BYTE buff[], RESP Resp)
{
  ...
  SDif[IfNum].Clk <: 0; t :> time; time += 10; t when __builtin_timer_after(time) :> void; SDif[IfNum].Cmd <: >> i; SDif[IfNum].Clk <: 1; time += 10; t when __builtin_timer_after(time) :> void;
  ...
  RespBitCount = 0;
  SDif[IfNum].Clk <: 0; t :> time; time += 10; t when __builtin_timer_after(time) :> void; SDif[IfNum].Cmd <: >> i; SDif[IfNum].Clk <: 1; time += 10; t when __builtin_timer_after(time) :> void;
  for(i = 32; i; i--) { SDif[IfNum].Clk <: 0; t :> time; time += 10; t when __builtin_timer_after(time) :> void; SDif[IfNum].Cmd <: >> Arg; SDif[IfNum].Clk <: 1; time += 10; t when __builtin_timer_after(time) :> void; }
  SDif[IfNum].Clk <: 0; t :> time; time += 10; t when __builtin_timer_after(time) :> void; SDif[IfNum].Cmd <: >> Crc0; SDif[IfNum].Clk <: 1; time += 10; t when __builtin_timer_after(time) :> void;
  RespByteCount = 0;
  SDif[IfNum].Clk <: 0; t :> time; time += 10; t when __builtin_timer_after(time) :> void; SDif[IfNum].Cmd <: >> Crc0; SDif[IfNum].Clk <: 1; time += 10; t when __builtin_timer_after(time) :> void;
  Dat = 0xFFFFFFFF;
  SDif[IfNum].Clk <: 0; t :> time; time += 10; t when __builtin_timer_after(time) :> void; SDif[IfNum].Cmd <: >> Crc0; SDif[IfNum].Clk <: 1; time += 10; t when __builtin_timer_after(time) :> void;
...
DSTATUS disk_initialize(BYTE IfNum)
{
  ...
  read_sswitch_reg(
# 438 "C:/MEGA/HobbyElec/SSDAC/xSSDAC/xTIME/WORKSPACE040/module_sdcard4bit/src/SDCardHost4Bit.xc"
